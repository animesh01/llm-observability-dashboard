...
# ---- hero
art = (
    "<svg class='hero-art' width='150' height='106' viewBox='0 0 150 106' fill='none'>"
    "<circle cx='118' cy='40' r='62' fill='rgba(255,255,255,0.06)'/>"
    "<circle cx='52' cy='62' r='40' fill='none' stroke='rgba(255,255,255,0.25)' stroke-width='2'/>"
    "<circle cx='52' cy='62' r='27' fill='none' stroke='rgba(255,255,255,0.4)' stroke-width='2'/>"
    "<circle cx='52' cy='62' r='14' fill='none' stroke='rgba(255,255,255,0.6)' stroke-width='2'/>"
    "<circle cx='52' cy='62' r='4' fill='#fff'/>"
    "<path d='M14 30 L40 30 L48 14 L60 46 L70 30 L96 30' stroke='#fff' stroke-width='3' fill='none' stroke-linecap='round' stroke-linejoin='round'/>"
    "<circle cx='112' cy='30' r='9' fill='#22b892' stroke='#fff' stroke-width='2.5'/></svg>"
)
st.markdown(
    f"""
    <div class="hero">
